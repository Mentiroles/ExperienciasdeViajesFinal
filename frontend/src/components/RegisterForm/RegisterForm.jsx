    ...
    <>
      <Form className="w-75 mx-auto mt-5" onSubmit={handleForm}>
        ...
        <Form.Group className="mb-3" >
          ...
          <Form.Control type="password" id='pass1' name='pass1' value={pass1} required onChange={(e) => setPass1(e.target.value)} />
        </Form.Group>
        <Form.Group className="mb-3" >
          <Form.Label>Repeat Password</Form.Label>
          <Form.Control type="password" id='pass2' name='pass2' value={pass2} required onChange={(e) => setPass2(e.target.value)}/>
        </Form.Group>
        <Form.Group className="mb-3">
        </Form.Group>
